...
ITSQCCluster::ITSQCCluster() : TaskInterface(), mHistogram(nullptr) { mHistogram = nullptr; }
...
void ITSQCCluster::initialize(o2::framework::InitContext& ctx)
{
  ...
  getObjectsManager()->addCheck(mHistogram, "checkFromITSQCCluster", "o2::quality_control_modules::itsqccluster::ITSQCClusterCheck",
                                "QcITSQCCluster");
}
