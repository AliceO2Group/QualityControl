...
#include "ITS/ITSTrackSimCheck.h"
...
void ITSTrackSimCheck::configure(std::string) {}

Quality ITSTrackSimCheck::check(std::map<std::string, std::shared_ptr<MonitorObject>>* moMap)
{
...
std::string ITSTrackSimCheck::getAcceptedType() { return "TH1D"; }

void ITSTrackSimCheck::beautify(std::shared_ptr<MonitorObject> mo, Quality checkResult)
{
