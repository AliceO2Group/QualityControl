...
namespace o2::quality_control_modules::its{
    ...
    void ITSClusterTask::monitorData(o2::framework::ProcessingContext& ctx){
	  ...
	  //  cout<<"Filling histo with ID: "<< cluster. getPatternID()  << " when we have dict until " << mDict.getSize() << " mod = "<< mod <<" sta "<< sta <<" lay "<< lay <<endl;
	    if (  cluster. getPatternID() >= mDict.getSize() ) continue;
    ...
    void ITSClusterTask::endOfCycle(){
      ...
      std::ifstream runNumberFile("/home/its/aisakov/workdir/infiles/RunNumber.dat"); //catching ITS run number in commissioning
      if (runNumberFile) {
    ...
    void ITSClusterTask::getEnableLayers(){
      std::ifstream configFile("Config/ConfigLayers.dat");
