...
void PostProcTask::initialize(Trigger, framework::ServiceRegistryRef services)
{
  ...
  mHistTrgValidation = helper::registerHist<TH1F>(getObjectsManager(), quality_control::core::PublicationPolicy::ThroughStop, "", "TrgValidation", "FDD SW + HW only to validated triggers fraction", mMapBasicTrgBits);
