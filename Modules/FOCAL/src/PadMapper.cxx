...
std::ostream& o2::quality_control_modules::focal::operator<<(std::ostream& stream, const PadMapper::ChannelIDException& except)
{
  except.print(stream);
  return stream;
}

std::ostream& o2::quality_control_modules::focal::operator<<(std::ostream& stream, const PadMapper::PositionException& except)
{
  except.print(stream);
  return stream;
}