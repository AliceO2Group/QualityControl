...
std::ostream& o2::quality_control_modules::focal::operator<<(std::ostream& stream, const ASICChannel& channel)
{
  stream << "(ADC) " << channel.getADC() << ", (TOA) " << channel.getTOA() << ", (TOT) " << channel.getTOT();
  return stream;
}

std::ostream& o2::quality_control_modules::focal::operator<<(std::ostream& stream, const ASICHeader& header)
{
...
std::ostream& o2::quality_control_modules::focal::operator<<(std::ostream& stream, const TriggerWord& trigger)
{
