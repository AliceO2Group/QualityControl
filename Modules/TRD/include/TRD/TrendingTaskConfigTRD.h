...
struct TrendingTaskConfigTRD : PostProcessingConfig {
  TrendingTaskConfigTRD() = default;
  TrendingTaskConfigTRD(std::string name, const boost::property_tree::ptree& config);
  ~TrendingTaskConfigTRD() = default;
