...
class TRDHelpers
{
 public:
  ...
  void drawChamberStatusOn2D(TH2F* hist, const std::array<int, o2::trd::constants::MAXCHAMBER>* ptrChamber);
 ...
 private:
  void drawHashOnLayers(int layer, int hcid, int rowstart, int rowend, int unitspersection, std::array<std::shared_ptr<TH2F>, o2::trd::constants::NLAYER> mLayers);
