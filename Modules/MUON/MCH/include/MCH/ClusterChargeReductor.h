...
///
/// \file   ClusterChargeReductor.h
/// \author Andrea Ferrero
///
#ifndef QUALITYCONTROL_CLUSTERCHARGEREDUCTOR_H
...
class ClusterChargeReductor : public quality_control::postprocessing::Reductor
{
 public:
  ...
  ~ClusterChargeReductor() = default;

  void* getBranchAddress() override;
  const char* getBranchLeafList() override;
  void update(TObject* obj) override;

  Double_t getDeValue(int deid);
...
#endif // QUALITYCONTROL_CLUSTERCHARGEREDUCTOR_H
