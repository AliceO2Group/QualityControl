...
{
 public:
  RawCheckerDeviceDPL<RAWCHECKER>(const std::vector<uint16_t>& feeIds, const o2::mid::CrateMasks& crateMasks, const o2::mid::ElectronicsDelay& electronicsDelay) : mFeeIds(feeIds), mCrateMasks(crateMasks), mElectronicsDelay(electronicsDelay) {}
  ...
  void init(o2::framework::InitContext& ic)
  {
    ...
    if constexpr (std::is_same_v<RAWCHECKER, o2::quality_control_modules::mid::RawDataChecker>) {
  ...
  void run(o2::framework::ProcessingContext& pc)
  {
    ...
    auto data = o2::framework::DataRefUtils::as<const o2::mid::ROBoard>(msg);

    auto msgROF = pc.inputs().getByPos(1);
    auto inROFRecords = o2::framework::DataRefUtils::as<const o2::mid::ROFRecord>(msgROF);
 ...
 private:
  ...
  o2::mid::CrateMasks mCrateMasks{};             ///< Crate masks file
  o2::mid::ElectronicsDelay mElectronicsDelay{}; ///< Delay in the electronics
  ...
  framework::DataProcessorSpec getRawCheckerSpec(const std::vector<uint16_t>& feeIds, const o2::mid::CrateMasks& crateMasks, const o2::mid::ElectronicsDelay& electronicsDelay, bool perGBT)
{
  ...
  return o2::framework::DataProcessorSpec{
    ...
    perGBT ? o2::framework::AlgorithmSpec{
      o2::framework::adaptFromTask<RawCheckerDeviceDPL<o2::quality_control_modules::mid::GBTRawDataChecker>>(feeIds, crateMasks, electronicsDelay)}
    : o2::framework::adaptFromTask<RawCheckerDeviceDPL<o2::quality_control_modules::mid::RawDataChecker>>(feeIds, crateMasks, electronicsDelay),
