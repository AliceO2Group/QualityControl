...
#ifndef QUALITYCONTROL_MIDTRENDING_H
#define QUALITYCONTROL_MIDTRENDING_H
...
class MIDTrending : public PostProcessingInterface
{
 public:
  MIDTrending() = default;
  ~MIDTrending() override = default;
...
#endif // QUALITYCONTROL_MIDTRENDING_H
