...
/// \code{.sh}
/// o2-qc-run-digits-hot-pixel-root-file-reader-mft --mft-digit-infile=some_data_file | o2-qc --config json://${QUALITYCONTROL_ROOT}/etc/your_config.json
/// \endcode
///
...
class DigitsRootFileReaderMFT : public o2::framework::Task
{
 public:
  ...
  void run(framework::ProcessingContext& pc)
  {
    ...
    AddHotPixel(DigitsInROF, 413, 200, 200, 165);
    AddHotPixel(DigitsInROF, 513, 200, 200, 165);
    AddHotPixel(DigitsInROF, 800, 200, 200, 165);
