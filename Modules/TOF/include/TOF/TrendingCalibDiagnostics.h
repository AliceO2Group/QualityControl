...
///
/// \file    TrendingCalibDiagnostics.h
/// \author  Sofia Tomassini
/// \author Francesca Ercolessi

#ifndef QC_MODULE_TOF_TRENDING_CALIB_DIAGNOSTICS_H
#define QC_MODULE_TOF_TRENDING_CALIB_DIAGNOSTICS_H
...
class TrendingCalibDiagnostics : public PostProcessingInterface
{
 public:
  TrendingCalibDiagnostics() = default;
  ~TrendingCalibDiagnostics() override = default;
...
#endif // QC_MODULE_TOF_TRENDING_CALIB_DIAGNOSTICS_H
