...
class CalibMonitoringTask final : public quality_control::postprocessing::PostProcessingInterface
{
 ...
 public:
  ...
  TH2* mMaskStatsEMCALHisto = nullptr;          ///< Monitor number of good, bad, dead cells in emcal only
  TH2* mMaskStatsDCALHisto = nullptr;           ///< Monitor number of good, bad, dead cells in dcal only
  TH2* mMaskStatsAllHisto = nullptr;           ///< Monitor number of good, bad, dead cells in emcal + dcal only
