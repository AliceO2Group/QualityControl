...
BOOST_AUTO_TEST_CASE(test_simple_json_merge)
{
...
BOOST_AUTO_TEST_CASE(test_json_merge_2_tasks)
{
...
BOOST_AUTO_TEST_CASE(test_json_merge_simple_arrays)
{
  cout << "test_json_merge_simple_arrays" << endl;
  ...
  core::printTree(tree1);
  core::printTree(tree2);
  core::printTree(merged);
...
BOOST_AUTO_TEST_CASE(test_json_merge_arrays_objects)
{
...
BOOST_AUTO_TEST_CASE(test_json_merge_arrays_of_arrays)
{
