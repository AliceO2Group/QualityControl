...
// fixme: this might fail when invoked concurrently.
//  I keep it here as disabled, it can be used when needed,
//  but ideally we should find a way to test it continuously.
/*
