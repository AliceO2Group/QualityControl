...
class Bookkeeping
{
 public:
  ...
  void registerProcess(int runNumber, const std::string& name, const std::string& detector, o2::bkp::DplProcessType type, const std::string& args);
 ...
 private:
  ...
  std::string mUrl = "";
  std::unique_ptr<o2::bkp::api::BkpClient> mClient;
};
