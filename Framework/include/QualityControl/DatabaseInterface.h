...
class DatabaseInterface
{
 public:
   ...
   * @deprecated
   */
  virtual std::shared_ptr<o2::quality_control::core::MonitorObject> retrieveMO(std::string objectPath, std::string objectName, long timestamp = Timestamp::Current, const core::Activity& activity = {}, const std::map<std::string, std::string>& metadata = {}) = 0;
  /**
