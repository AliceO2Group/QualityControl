...
class TaskRunnerFactory
{
 public:
  ...
  static framework::InputSpec createTimerInputSpec(const CommonSpec& globalConfig, int& cycleDurationSeconds, std::vector<std::pair<size_t, size_t>>& cycleDurations, const std::string& detectorName, const std::string& taskName);
};
