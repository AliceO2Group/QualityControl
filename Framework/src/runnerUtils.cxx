...
Activity computeActivity(framework::ServiceRegistryRef services, const Activity& fallbackActivity)
{
  ...
  auto run_start_time_ms = computeNumericalActivityField<unsigned long>(services, "runStartTimeMs", fallbackActivity.mValidity.getMin());
  auto run_stop_time_ms = computeNumericalActivityField<unsigned long>(services, "runEndTimeMs", fallbackActivity.mValidity.getMax());
